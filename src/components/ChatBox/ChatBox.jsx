...
const ChatBox = () => {
    ...
    useEffect(() => {
        ...
        }, 0.01); // Ajusta el tiempo de retraso según sea necesario
    }, [messages]);

    // Manejar el evento de tecla "Enter"
    const handleKeyDown = (event) => {
        if (event.key === 'Enter' && !event.shiftKey) {
            event.preventDefault(); // Evita el salto de línea si se presiona "Enter"
        ...
        <Stack gap={4} className="chat-box">
            ...
            <Stack direction="horizontal" gap={3} className="chat-input flex-grow-0">
                <InputEmoji
                    ...
                    onKeyDown={handleKeyDown} // Asignar el controlador de eventos aquí
                    cleanOnEnter // Opción para limpiar el campo después de presionar Enter
